package com.example.chatapp.customViews.numericKeyboard
...
import com.example.chatapp.customViews.numericKeyboard.listener.KeyClickListener
import com.example.chatapp.R
import com.example.chatapp.customViews.numericKeyboard.util.ViewRunnable
import com.example.chatapp.customViews.numericKeyboard.util.suppressSoftKeyboard
...
class NumericKeyboard : FrameLayout {
    ...
    private fun initViews() {
        ...
        val layout = inflater.inflate(R.layout.numeric_keyboard, this, false)
    ...
    private fun updateView(layout: View) {
        ...
        val keyRemove = layout.findViewById<ImageView>(R.id.keyRemove)
